...
This document defines governance policies for the Kuma GUI project.

## Maintainers

Kuma GUI Maintainers have write access to the Kuma GUI GitHub repository https://github.com/Kong/kuma-gui.
...
A new maintainer must be proposed by an existing maintainer by opening an issue (with title `Maintainer Nomination`) to the Kuma GUI Github repository (https://github.com/Kong/kuma-gui) containing the following information:
...
Maintainers will be added to the GitHub @Kong/kuma-gui-maintainers team, and made a GitHub maintainer of that team.
They will be given write permission to the Kuma GUI GitHub repository https://github.com/Kong/kuma-gui.
