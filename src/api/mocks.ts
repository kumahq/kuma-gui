...
const mockFileImports: Array<[string, () => Promise<any>]> = [
  ...
  ['meshes/default/external-services/httpbin', () => import('./mock-data/meshes/default/external-services/httpbin.json')],
  ['meshes/default/external-services/httpbin2', () => import('./mock-data/meshes/default/external-services/httpbin2.json')],
