              ...
              >
                ...
                >
                  <KIcon
                    ...
                    style="margin:auto"
                  />
                  <div slot="content"><b>{{ row.totalRejectedUpdates }} rejection(s) </b>. Some configuration changes were rejected by Envoy. The most common reason is that the configuration generated by the control plane may be invalid. Check {{ process.env.VUE_APP_NAMESPACE }} DP sidecar logs for more details.</div>
                </KPop>
              </span>
            </span>
          </template>
