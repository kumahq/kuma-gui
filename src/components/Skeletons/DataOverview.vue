          ...
          >
            <span class="entity-total-updates">
              ...
              >
                <KoolTip
                  alignment="center"
                  :message="rejectionHelperMessage(row.totalRejectedUpdates)"
                >
                  <KIcon
...
export default {
  ...
  methods: {
    ...
    rejectionHelperMessage (totalRejectedUpdates) {
      return `${totalRejectedUpdates} rejections. Some configuration changes were rejected by Envoy. The most common reason is that the configuration generated by the control plane may be invalid. Check Kuma DP sidecar logs for more details.`
    }
  }
}
</script>
