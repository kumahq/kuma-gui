        ...
        >
          ...
          >
            <span class="entity-total-updates">
              ...
              <!--                    style="margin:auto"-->
              <!--                  />-->
              <!--                  <div slot="content"><b>{{ row.totalRejectedUpdates }} rejection(s) </b>. Some configuration changes were rejected by Envoy. The most common reason is that the configuration generated by the control plane may be invalid. Check {{ $productName }} DP sidecar logs for more details.</div>-->
              <!--                </KPop>-->
              <!--              </span>-->
            </span>
          </template>
