...
export default (api) => {
  const store = new Vuex.Store({
    ...
    state: {
      ...
      totalTotalProxyTemplateCountFromMesh: 0,
    ...
    getters: {
      ...
      getTotalHealthChecksCountFromMesh: (state) => state.totalHealthChecksCountFromMesh,
      getTotalProxyTemplatesCountFromMesh: (state) => state.totalProxyTemplatesCountFromMesh,
      getTotalTrafficLogsFromMesh: (state) => state.totalTrafficLogsCountFromMesh,
      getTotalTrafficTracesFromMesh: (state) => state.totalTrafficTracesCountFromMesh,
    ...
    mutations: {
      ...
      SET_TOTAL_PROXY_TEMPLATE_COUNT_FROM_MESH: (state, count) => (state.totalTotalProxyTemplateCountFromMesh = count),
