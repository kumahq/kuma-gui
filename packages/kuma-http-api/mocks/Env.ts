export type Env = keyof {
  ...
  KUMA_DATAPLANELISTENER_COUNT: string
  ...
  KUMA_MESHACCESSLOG_COUNT: string
  KUMA_MESHIDENTITY_COUNT: string
  KUMA_MESHTRUST_COUNT: string
  KUMA_MESHZONEADDRESS_COUNT: string
  ...
  KUMA_WORKLOAD_COUNT: string
  KUMA_RESOURCES_ROUTE_ENABLED: string
  KUMA_DATAPLANE_ZONEPROXY_TYPE: string
}
