Feature: mesh / dataplanes / navigation
  ...
  # Extracted from features/mesh/legacy-dataplanes/Navigation.feature: the example
  # rows that navigated to the dataplane list via the (removed) legacy internal
  # service detail route `/meshes/default/services/internal/<service>/overview`.
