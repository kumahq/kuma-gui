Feature: Policy summary
  ...
  Scenario: Clicking a row opens the summary
    Given the environment
      ...
      """
    When I visit the "/meshes/default/policies/mfi" URL
  ...
  Scenario: Summary URL goes to page with open summary
    Given the environment
      ...
      """
    When I visit the "/meshes/default/policies/mfi/kri_mfi_default___mfi-1_?page=2&size=50" URL
    Then the "$summary" element exists
  ...
  Rule: Offering different view formats
    ...
    Scenario: Switching to k8s format and back
      When I visit the "/meshes/default/policies/mfi/kri_mfi_default___mfi-1_" URL
    ...
    Scenario: The view for k8s format exists
      When I visit the "/meshes/default/policies/mfi/kri_mfi_default___mfi-1_?format=k8s" URL
      Then the "[data-testid='codeblock-yaml-k8s']" element exists

    Scenario: The view for universal format exists
      When I visit the "/meshes/default/policies/mfi/kri_mfi_default___mfi-1_?format=universal" URL
