  ...
  >
    <AppView>
      <XLayout variant="y-stack">
        ...
        >
          <template #title>
            {{ t('zone-egresses.routes.item.about.title') }}
          </template>
          <DataLoader
            :data="[props.data]"
          ...
          >
            <XTimespan
              :start="zoneEgress.creationTime"
              :end="zoneEgress.modificationTime"
            />
            <XLayout variant="y-stack">
              <XDl variant="x-stack">
                <div>
                ...
                <div>
                  ...
                  <dd>
                    <XCopyButton
                      v-if="zoneEgress.zoneEgress.socketAddress.length > 0"
                      variant="badge"
                      format="default"
                      :text="zoneEgress.zoneEgress.socketAddress"
                    />
                ...
                <template
                  v-for="labels in [Object.entries(zoneEgress.labels)]"
                  :key="typeof labels"
                >
              ...
              <XLayout
                v-if="zoneEgress.zoneEgressInsight.subscriptions.length > 0"
                variant="y-stack"
              ...
              >
                ...
                <template
                  v-for="subscription in [zoneEgress.zoneEgressInsight.connectedSubscription]"
                ...
                >
                  <template v-if="!subscription?.disconnectTime && subscription?.connectTime">
                    <XDl variant="x-stack">
                      <div>
                        <dt>
                          {{ t('zone-egresses.routes.item.subscriptions.connected') }}
                        </dt>
                        <dd>
                      ...
                      <div>
                        <dt>
                          {{ t('zone-egresses.routes.item.subscriptions.instance') }}
                        </dt>
                        <dd>
                      ...
                      <div>
                        <dt>
                          {{ t('zone-egresses.routes.item.subscriptions.version') }}
                        </dt>
                        <dd>
                          <XBadge appearance="info">
          ...
          >
            ...
            <template #default="{ data: [zoneEgress] }">
              ...
              >
                ...
                <template #default="{ data: [traffic], refresh }">
                  <XLayout
                    variant="columns"
                  >
                    <ConnectionTraffic>
...
const props = defineProps<{
  data: ZoneEgressOverview | Error | undefined
}>()
