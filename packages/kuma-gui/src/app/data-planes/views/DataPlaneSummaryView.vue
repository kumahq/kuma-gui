<template>
  ...
  >
    <DataLoader
      :src="typeof props.items === 'undefined' ? uri(sources, '/meshes/:mesh/dataplanes/:name', {
    ...
    >
      <DataLoader
        :src="typeof props.items === 'undefined' ? uri(sources, '/meshes/:mesh/dataplane-overviews/:name', {
          mesh: route.params.mesh,
          name: dataplane.id,
        }) : undefined"
      ...
      >
        <DataCollection
          :items="typeof props.items !== 'undefined' ? props.items : [dataplaneOverview]"
