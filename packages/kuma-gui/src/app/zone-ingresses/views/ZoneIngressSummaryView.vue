<template>
  ...
  >
    <DataLoader
      :src="typeof props.items === 'undefined' ? uri(sources, '/zone-ingresses/:name', {
        name: route.params.proxy,
      }) : undefined"
      v-slot="{ data: [zoneIngress] }"
    >
      <DataLoader
        :src="typeof props.items === 'undefined' ? uri(sources, '/zone-ingress-overviews/:name', {
          name: zoneIngress.id,
        }) : undefined"
        v-slot="{ data: [zoneIngressOverview] }"
      >
        <DataCollection
          :items="typeof props.items !== 'undefined' ? props.items : [zoneIngressOverview]"
...
const props = defineProps<{
  items: ZoneIngressOverview[] | undefined
}>()
</script>
