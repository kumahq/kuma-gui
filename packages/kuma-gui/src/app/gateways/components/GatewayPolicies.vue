  ...
  <template v-if="!can('use zones')">
    <div>
      ...
      <template v-if="props.data.dataplaneType === 'builtin'">
        <DataLoader
          :src="uri(sources, '/meshes/:mesh/dataplanes/:name/gateway-dataplane-policies', {
...
import BuiltinGatewayPolicies from './BuiltinGatewayPolicies.vue'
...
import { sources as sources } from '@/app/gateways/sources'
